...
'''lil = [2,3,4,5,[45,56,67,78,[111,222,333,[5555,3333,[10000,50000,"python","computer"],1111,7777,8888],444,555,666,777],89,23,34]]
print(lil[3])
print(lil[4][1])
print(lil[4][4][1])
print(lil[4][4][3][2][1])
print(lil[4][4][3][2][3][3:6])
print(lil[4][4][3][0])
print(lil[4][4][3][4])
print(lil[4][4][-2])
print(lil[4][-3])
print(lil[4][4][3][2][2][3:])
print(lil[4][4][2])
print(lil[4][4][3][1])'''
...
#Covert below two set in to a list
'''set1 = {5,4,3,6,2,7,1}
print(list(set1))'''
